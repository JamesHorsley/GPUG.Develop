...
namespace GPUG.Develop
{
    ...
    /// </summary>
    public class Lesson_3b : IDexterityAddIn
    {
        private PmVendorMaintenanceForm vendorForm = Dynamics.Forms.PmVendorMaintenance;

        public void Initialize()
        {
            vendorForm.AddMenuHandler(addVendorData, "Add Vendor Data", null);
        }


        // creates a new vendor record
        private void addVendorData(object sender, EventArgs e)
        {
            ...
            // set the fields that will be populated prior to saving the record
            // users should also add a record to the vendor address table if intending to keep this information.
            row.VendorId.Value = "0000TESTVENDOR";
            row.VendorName.Value = "Test Vendor Name";
            row.VendorAddressCodePrimary.Value = "PRIMARY";
            row.VendorContact.Value = "Contact";
            row.Address1.Value = "123 Anystreet";
            row.City.Value = "Tampa";
            row.State.Value = "FL";
            ...
            // update the vendor maintenance window 
            ...
            // load the new vendor record
            vendorForm.PmVendorMaintenance.VendorId.Value = "0000TESTVENDOR";
            vendorForm.PmVendorMaintenance.VendorId.RunValidate();
        }
